...
ostream &operator<<(ostream &out, const Budget &budget)
{
    ...
    out << "==================================================================\n";
    out << setw(10) << left << "Budget ID"
        << " | " << setw(20) << left << "Title"
        << " | " << setw(6) << left << "Money"
        << " | " << endl;
    out << "===================================================================\n";
    out << setw(10) << left << budget.id
        << " | " << setw(20) << left << budget.title
        << " | " << setw(6) << left << budget.expenseMoney
        << " | " << endl;
    return out;
}
...
{
    out << "=======================================================================================================\n";
    out << setw(11) << left << "Reminder ID"
        << " | " << setw(20) << left << "Title"
        << " | " << setw(50) << left << "Message"
        << " | " << endl;
    out << "========================================================================================================\n";
    out << setw(11) << left << reminder.id
        << " | " << setw(20) << left << reminder.title
        << " | " << setw(50) << left << reminder.description
        << " | " << endl;
    ...
    void modifyReminder()
    {
        ...
        while ((fp.read((char *)&reminder, sizeof(Reminder))) && found == 0)
        {
            if (strcmpi(reminder.getReminderID(), n) == 0)
            {
                ...
                long long unsigned int pos = -1 * sizeof(Reminder);
